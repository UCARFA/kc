...
public class PHS398FellowshipSupplementalV3_1GeneratorTest extends
        S2SModularBudgetTestBase {

    @Override
    protected String getFormGeneratorName() {
        return PHS398FellowshipSupplementalV3_1Generator.class.getSimpleName();
    }
    ...
    protected void prepareS2sData(ProposalDevelopmentDocument document) {
        ...
        s2sOppFormsId.setOppNameSpace("http://apply.grants.gov/forms/PHS_Fellowship_Supplemental_3_1-V3.1");
        s2sOppForms.setFormName("PHS_Fellowship_Supplemental_3_1");
    ...
    protected void saveAnswers(ProposalDevelopmentDocument document) {
        ...
        for (AnswerHeader answerHeader : rawAnswerHeaders) {
            if (answerHeader.getLabel().contains("PHS Fellowship Supplemental 3.1")) {
