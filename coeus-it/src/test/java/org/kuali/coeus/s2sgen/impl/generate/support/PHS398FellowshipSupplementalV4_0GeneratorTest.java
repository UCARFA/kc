...
public class PHS398FellowshipSupplementalV4_0GeneratorTest extends
        S2SModularBudgetTestBase {

    @Override
    protected String getFormGeneratorName() {
        return PHS398FellowshipSupplementalV4_0Generator.class.getSimpleName();
    }
    ...
    protected void prepareS2sData(ProposalDevelopmentDocument document) {
        ...
        s2sOppFormsId.setOppNameSpace("http://apply.grants.gov/forms/PHS_Fellowship_Supplemental_4_0-V4.0");
        s2sOppForms.setFormName("PHS_Fellowship_Supplemental_4_0");
    ...
    protected void prepareData(ProposalDevelopmentDocument document)
        ...
        Narrative narrative10 = new Narrative();
        narrative10.setDevelopmentProposal(document.getDevelopmentProposal());
        NarrativeType narrativeType10 = new NarrativeType();
        narrativeType10.setCode("156");
        narrativeType10.setAllowMultiple(false);
        narrativeType10.setSystemGenerated(false);
        narrativeType10.setDescription("Test for Attachment");
        getService(DataObjectService.class).save(narrativeType10);
        narrative10.setName("exercise1");
        narrative10.setNarrativeType(narrativeType10);
        narrative10.setNarrativeTypeCode("156");
        narrative10.setNarrativeAttachment(narrativeAttachment);
        narrative10.setModuleNumber(10);
        narrative10.setModuleSequenceNumber(10);
        narrative10.setModuleStatusCode("C");
        narrative10.setDevelopmentProposal(document.getDevelopmentProposal());
        narrativeList.add(narrative10);
    ...
    protected void saveAnswers(ProposalDevelopmentDocument document) {
        ...
        for (AnswerHeader answerHeader : rawAnswerHeaders) {
            if (answerHeader.getLabel().contains("PHS Fellowship Supplemental 4.0")) {
                ...
                for (Answer answer : answerDetails) {
                    if (1 == answer.getQuestion().getQuestionSeqId()) {
                        ...
                        answer.setAnswer("N");
                    } else if (200 == answer.getQuestion().getQuestionSeqId()) {
                        answer.setAnswer("100 Biochemistry");
                    }
