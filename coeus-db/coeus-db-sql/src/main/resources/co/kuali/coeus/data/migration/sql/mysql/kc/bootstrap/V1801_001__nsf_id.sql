...
--
ALTER TABLE PERSON_EXT_T ADD NSF_ID DECIMAL(12,0);
ALTER TABLE EPS_PROP_PERSON ADD NSF_ID DECIMAL(12,0);
...
VALUES ((SELECT MAX(ID) FROM SEQ_PERSON_EDITABLE_FIELD),3,'nsfId','Y','admin',NOW(),UUID(),1);