...
values (seq_notification_type_id.nextval, 1, '-1', 'Award Report Tracking PI Digest Notification', '{PI_NAME} Due and Overdue Reports',
...
values (seq_notification_type_id.nextval, (select notification_type_id from notification_type where module_code = 1 and action_code = '-1'), 'KC-AWARD:PI', 'admin', SYSDATE, 1, sys_guid(), null);
