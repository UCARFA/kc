...
WHERE FORM_ID = 'FDP Modification';
COMMIT;
INSERT INTO SUBAWARD_FORMS (FORM_ID, DESCRIPTION, UPDATE_TIMESTAMP, UPDATE_USER, FORM, FILE_NAME, CONTENT_TYPE, VER_NBR, OBJ_ID, TEMPLATE_TYPE_CODE)
VALUES ('FDP Modification', 'FDP Modification', sysdate, 'admin', EMPTY_CLOB(), 'FDP_Modification_Template.xsl',
        'application/octet-stream', 1, SYS_GUID(), 4);
DECLARE data CLOB;
...
BEGIN
  ...
  FROM SUBAWARD_FORMS
  WHERE
    TEMPLATE_TYPE_CODE = 4 AND FORM_ID = 'FDP Modification'
  FOR UPDATE;
