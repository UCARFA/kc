...
values (seq_s2s_error_id.nextval, '/GrantApplication/Forms/PHS_Fellowship_Supplemental_4_0/AdditionalInformation/CurrentPriorNRSASupportIndicator',
'The PHS Fellowship Supplemental 4.0 questionnaire must be completed on the Questions tab.', 'questions', SYSDATE, 'admin', 1, sys_guid());
