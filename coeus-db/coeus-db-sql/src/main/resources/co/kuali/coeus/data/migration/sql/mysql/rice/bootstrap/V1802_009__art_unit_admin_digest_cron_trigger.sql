...
insert into krcr_parm_t (nmspc_cd, cmpnt_cd, parm_nm, obj_id, ver_nbr, parm_typ_cd, val, parm_desc_txt, eval_oprtr_cd, appl_id)
values ('KC-AWARD', 'Document', 'Ascend_Unit_Hierarchy_For_Report_Tracking_Digest_Unit_Admins', uuid(), 1, 'CONFG', '0 59 23 15 * ?', 'Determines whether or not award report tracking digest notifications should be sent to all Unit Administrators at or above the units associated with reports in the digest. Default value is true.', 'A', 'KC');
