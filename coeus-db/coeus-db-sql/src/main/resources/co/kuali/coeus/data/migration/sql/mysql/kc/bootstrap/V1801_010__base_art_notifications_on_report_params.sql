...
update award_report_notification_sent arns
	inner join award_report_terms art on arns.award_report_term_id = art.award_report_terms_id
set arns.report_class_code = art.report_class_code, arns.report_code = art.report_code;
