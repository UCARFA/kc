...
BEGIN
  ...
  WHERE
    TEMPLATE_TYPE_CODE=4 AND FORM_ID = 'FDP Template' FOR UPDATE;
  buffer := '                                                        <fo:table-cell  padding="2pt"  border="solid 1pt gray" display-align="center">
<fo:block>
<fo:inline>
...
BEGIN
  ...
  WHERE
    TEMPLATE_TYPE_CODE=4 AND FORM_ID = 'FDP Template' FOR UPDATE;
  buffer := '<fo:table-cell padding="1pt"  >
<fo:block>
<fo:inline>
...
BEGIN
  ...
  WHERE
    TEMPLATE_TYPE_CODE=4 AND FORM_ID = 'FDP Template' FOR UPDATE;
  buffer := '<fo:table-row font-size="10pt" font-weight="bold">
...
BEGIN
  ...
  WHERE
    TEMPLATE_TYPE_CODE=4 AND FORM_ID = 'FDP Template' FOR UPDATE;
  buffer := '<xsl:when test="subcontract:SubContractData/subcontract:SubcontractTemplateInfo/subcontract:SowOrSubProposalBudget  = &quot;Y&quot;">
<fo:inline font-family="Arial" font-size="9pt" font-weight="normal">
<xsl:text>&#160;</xsl:text>
</fo:inline>
<fo:external-graphic content-height="8" content-width="7">
...
<fo:block/> <xsl:text>7) The PTE  may issue non-substantive changes to the Period of Performance  (check one) </xsl:text>
';
  DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
end;
/
...
BEGIN
  ...
  buffer := '
                                               <fo:external-graphic content-height="8" content-width="8">
                                                ...
                                                <fo:block/>
                                                <fo:inline font-family="Arial" font-size="9pt" font-weight="normal">
                                                    <xsl:text>9) Either party may terminate this subaward with 30 days written notice to the appropriate party&apos;s </xsl:text>
                                                </fo:inline>
                                                <xsl:for-each select="subcontract:SubContractData">
                                                    <xsl:for-each select="subcontract:SubcontractTemplateInfo">
...
<fo:inline font-family="Arial" font-size="9pt" font-weight="normal">
<xsl:text> as shown in Attachments 3A &amp; 3B. PTE shall pay Subrecipient for termination costs as allowable under Uniform Guidance, 2 CFR 200 or 45 CFR Part 75 Appendix IX, as applicable.</xsl:text>
</fo:inline>
<fo:block/>
<fo:inline font-family="Arial" font-size="9pt" font-weight="normal">
<xsl:text>10) No-cost extensions require the approval of the PTE. Any requests for a no-cost extension shall be directed to the</xsl:text>
</fo:inline>
<fo:inline>
<xsl:text>&#160;</xsl:text>
</fo:inline>
...
BEGIN
  ...
  WHERE
    TEMPLATE_TYPE_CODE=4 AND FORM_ID = 'FDP Template' FOR UPDATE;
  buffer := '<fo:table-row font-size="9pt" font-weight="normal">
<fo:table-cell border="solid 1pt gray" padding="1pt" display-align="center">
<fo:block>
<fo:inline-container>
<fo:block>
...
<fo:block>
<fo:inline font-family="Arial" font-size="12pt" font-weight="bold">
<xsl:text>Certification Regarding Lobbying (2 CFR 200.450)</xsl:text>
</fo:inline>
</fo:block>
</fo:block>
</fo:block>
...
<fo:block text-align="left" margin="0pt">
<fo:inline font-family="Arial" font-size="12pt" font-weight="bold">
<xsl:text>Debarment, Suspension, and Other Responsibility Matters (2 CFR 200.213 and 2 CFR 180)</xsl:text>
</fo:inline>
</fo:block>
</fo:block>
</fo:block>
...
BEGIN
  ...
  WHERE
    TEMPLATE_TYPE_CODE=4 AND FORM_ID = 'FDP Template' FOR UPDATE;
  buffer := '<fo:block text-align="left" margin="0pt">
<fo:block>
<fo:inline font-family="Arial" font-size="12pt" font-weight="bold">
...
<fo:block/>
<fo:inline font-family="Arial" font-size="9pt">
<xsl:text>Neither party shall use the other party’s name, trademarks, or other logos in any publicity, advertising, or news release without the prior written approval of an authorized representative of that party. The parties agree that each party may use factual information regarding the existence and purpose of the relationship that is the subject of this Agreement for legitimate business purposes, to satisfy any reporting and funding obligations, or as required by applicable law or regulation without written permission from the other party. In any such statement, the relationship of the parties shall be
accurately and appropriately described</xsl:text>
</fo:inline>
</fo:block>
</fo:table-cell>
</fo:table-row>
