...
VALUES ((SELECT MAX(ID) FROM SEQ_VALID_NARR_FORMS_ID),'Project_1_2-V1.2',(SELECT NARRATIVE_TYPE_CODE FROM NARRATIVE_TYPE WHERE DESCRIPTION = 'Project_Attachments'),'N','admin',NOW(),UUID());
