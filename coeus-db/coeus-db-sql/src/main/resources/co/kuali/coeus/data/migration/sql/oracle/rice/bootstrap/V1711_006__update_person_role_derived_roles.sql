...
values ('RESBOOT-1001', sys_guid(), 1, 'MPI', 'KC-PD', 'Proposal Development Multiple PI Derived Role', (select kim_typ_id from krim_typ_t where nmspc_cd = 'KC-PD' and nm = 'Derived Role: Investigators'), 'Y', SYSDATE);
...
update krim_typ_t set nm = '[DEPRECATED] ' || nm where srvc_nm = '{http://kc.kuali.org/core/v5_0}proposalRoleTypeService' and nm != 'Derived Role: Investigators';
