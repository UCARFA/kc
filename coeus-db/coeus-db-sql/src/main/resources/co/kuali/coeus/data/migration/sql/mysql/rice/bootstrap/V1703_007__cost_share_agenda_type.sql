...
VALUES( 'RESBOOT-1001', UUID(), 1, 'Derived Role: Proposal Cost Share Unit Administrators', 'proposalCostShareUnitAdministratorDerivedRoleTypeService', 'Y', 'KC-PD');

-- create new roles
INSERT INTO KRIM_ROLE_T (ROLE_ID, OBJ_ID, VER_NBR, ROLE_NM, NMSPC_CD, DESC_TXT, KIM_TYP_ID, ACTV_IND, LAST_UPDT_DT)
VALUES ('RESBOOT-1000', UUID(), 1, 'Cost Share Approver Unit Admin', 'KC-PD', 'Proposal Cost Share Unit Administrators',  'RESBOOT-1001', 'Y', NOW());
...
INSERT INTO UNIT_ADMINISTRATOR_TYPE (UNIT_ADMINISTRATOR_TYPE_CODE,DESCRIPTION,DEFAULT_GROUP_FLAG,MULTIPLES_FLAG,UPDATE_USER,UPDATE_TIMESTAMP,OBJ_ID,VER_NBR)
    VALUES ('-1','COST_SHARE_ADMINISTRATOR','C','N','admin',NOW(),UUID(),1);

INSERT INTO KRCR_PARM_T (APPL_ID, NMSPC_CD, CMPNT_CD, PARM_NM, VAL, PARM_DESC_TXT, PARM_TYP_CD, EVAL_OPRTR_CD, OBJ_ID, VER_NBR)
VALUES ('KUALI', 'KC-PD', 'All', 'COST_SHARE_ADMINISTRATOR_TYPE_CODE', '-1', 'Cost share administrator type code', 'CONFG', 'A', UUID(), 1);