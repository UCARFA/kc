...
VALUES ((SELECT (MAX(ID))
         FROM SEQ_S2S_ERROR_ID), '/GrantApplication/Forms/PHS_Fellowship_Supplemental_4_0/ResearchTrainingPlan/ResearchStrategy',
...
INSERT INTO S2S_ERROR (S2S_ERROR_ID, MESSAGE_KEY, MESSAGE, FIX_LINK, UPDATE_TIMESTAMP, UPDATE_USER, VER_NBR, OBJ_ID)
VALUES ((SELECT (MAX(ID))
         FROM SEQ_S2S_ERROR_ID), '/GrantApplication/Forms/PHS_Fellowship_Supplemental_4_0/ResearchTrainingPlan/RespectiveContribution',
...
INSERT INTO S2S_ERROR (S2S_ERROR_ID, MESSAGE_KEY, MESSAGE, FIX_LINK, UPDATE_TIMESTAMP, UPDATE_USER, VER_NBR, OBJ_ID)
VALUES ((SELECT (MAX(ID))
         FROM SEQ_S2S_ERROR_ID), '/GrantApplication/Forms/PHS_Fellowship_Supplemental_4_0/ResearchTrainingPlan/SponsorandInstitution',
...
VALUES ((SELECT (MAX(ID))
        ...
        '/GrantApplication/Forms/PHS_Fellowship_Supplemental_4_0/ResearchTrainingPlan/TrainingInResponsibleConductOfResearch',
