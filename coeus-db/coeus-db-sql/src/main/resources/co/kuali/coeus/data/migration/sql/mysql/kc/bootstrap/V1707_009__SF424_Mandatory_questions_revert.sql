...
create table questionnaire_answer_bak07142017 as select * from questionnaire_answer;
create table QUESTIONNAIRE_QUESTIONS_bak07142017 as select * from QUESTIONNAIRE_QUESTIONS;
create table QUESTION_bak07142017 as select * from QUESTION;
