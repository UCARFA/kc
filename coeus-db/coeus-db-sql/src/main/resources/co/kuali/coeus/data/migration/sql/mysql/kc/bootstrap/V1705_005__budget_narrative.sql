...
VALUES ((SELECT MAX(ID) FROM SEQ_VALID_NARR_FORMS_ID),'Budget-V1.2',(SELECT NARRATIVE_TYPE_CODE FROM NARRATIVE_TYPE WHERE DESCRIPTION = 'Budget_Attachments'),'N','admin',NOW(),UUID());