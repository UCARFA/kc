...
insert into subaward_modification_type (code, description, active, update_user, update_timestamp, ver_nbr, obj_id)
	values ('RESBOOT1004', 'Carry Forward', 'Y', 'admin', now(), 1, uuid());
                                            ...
                                            <fo:block>
                                                        ...
                                                        <fo:block linefeed-treatment="preserve" margin="0pt" text-align="left">
                                                            <fo:block linefeed-treatment="preserve" margin="0pt" text-align="left">
                                                                <xsl:if test="subcontract:SubContractData/subcontract:SubcontractDetail/subcontract:ModificationType = &quot;RESBOOT1001&quot;">
                                                                    <fo:block>
                                                                        <fo:inline>
                                                                            <xsl:text>Additional funds in the amount of </xsl:text>
                                                                            <xsl:for-each select="subcontract:SubContractData">
                                                                                <xsl:for-each select="subcontract:SubcontractAmountInfo">
                                                                                    <xsl:for-each select="subcontract:ObligatedChange">
                                                                                        <fo:inline>
                                                                            ...
                                                                            <xsl:text> are hereby authorized for the current period.</xsl:text>
                                                                        </fo:inline>
                                                                            ...
                                                                            <fo:table-body>
                                                                                <fo:table-row>
                                                                                    <fo:table-cell padding="2pt" display-align="before">
                                                                                        <fo:block>
                                                                                            ...
                                                                                            <xsl:for-each select="subcontract:SubContractData">
                                                                                                <xsl:for-each select="subcontract:SubcontractAmountInfo">
                                                                                                    <xsl:for-each select="subcontract:ObligatedChangeDirect">
                                                                                                        <fo:inline>
                                                                                                            <xsl:text>$</xsl:text>
                                                                                                        </fo:inline>
                                                                                                        <fo:inline>
                                                                                ...
                                                                                <fo:table-row>
                                                                                    <fo:table-cell padding="2pt">
                                                                                        <fo:block>
                                                                                            <fo:inline>
                                                                                                <xsl:text>Indirect Costs:</xsl:text>
                                                                                            </fo:inline>
                                                                                            <xsl:for-each select="subcontract:SubContractData">
                                                                                                <xsl:for-each select="subcontract:SubcontractAmountInfo">
                                                                                                    <xsl:for-each select="subcontract:ObligatedChangeIndirect">
                                                                                                        <fo:inline>
                                                                                                            <xsl:text>$</xsl:text>
                                                                                                        </fo:inline>
                                                                                                        <fo:inline>
                                                                                    ...
                                                                                    <fo:table-cell padding="2pt" display-align="left">
                                                                                        <fo:block>
                                                                                            ...
                                                                                            <xsl:for-each select="subcontract:SubContractData">
                                                                                                <xsl:for-each select="subcontract:SubcontractAmountInfo">
                                                                                                    <xsl:for-each select="subcontract:Rate">
                                                                                                        <fo:inline>
                                                                                                            <xsl:text>%</xsl:text>
                                                                                                        </fo:inline>
                                                                                                        <fo:inline>
                                                                                ...
                                                                                <fo:table-row>
                                                                                    ...
                                                                                    <fo:table-cell padding="2pt" display-align="right">
                                                                                        <fo:block>
                                                                                            <fo:inline>
                                                                                            </fo:inline>
                                                                                        </fo:block>
                                                            ...
                                                            <fo:block linefeed-treatment="preserve" margin="2pt" text-align="left">
                                                                <xsl:if test="subcontract:SubContractData/subcontract:SubcontractDetail/subcontract:ModificationType = &quot;RESBOOT1000&quot;">
                                                                    <fo:block>
                                                                        ...
                                                                        <fo:table padding="0" table-layout="fixed" width="100%" border="1px">
                                                                            <fo:table-column column-width="100%"/>
                                                                            <fo:table-body>
                                                                                <fo:table-row>
                                                                                    <fo:table-cell padding="0" text-align="left" display-align="center">
                                                                                        <fo:block>
                                                                                            <fo:inline>
                                                                                                <xsl:text>This is a No Cost Extension. The Period of Performance is hereby extended through: </xsl:text>
                                                                                            </fo:inline>
                                                                                            <xsl:for-each select="subcontract:SubContractData">
                                                                                                <xsl:for-each select="subcontract:SubcontractDetail">
                                                                                                    <xsl:for-each select="subcontract:EndDate">
                                                            ...
                                                            <fo:block linefeed-treatment="preserve" margin="2pt" text-align="left">
                                                                <xsl:if test="subcontract:SubContractData/subcontract:SubcontractDetail/subcontract:ModificationType = &quot;RESBOOT1003&quot;">
                                                                    <fo:block>
                                                                        <fo:inline>
                                                                            <xsl:text>A detailed budget is included on the following pages and incorporated as Appendix A to this Amendment.</xsl:text>
                                                                        </fo:inline>
                                                                    </fo:block>
                                                                </xsl:if>
                                                            </fo:block>
                                                            ...
                                                            <fo:block linefeed-treatment="preserve" margin="2pt" text-align="left">
                                                                <xsl:if test="subcontract:SubContractData/subcontract:SubcontractDetail/subcontract:ModificationType = &quot;RESBOOT1004&quot;">
                                                                    <fo:block>
                                                                        <fo:table padding="0" table-layout="fixed" width="100%">
                                                                            ...
                                                                            <fo:table-body>
                                                                                <fo:table-row>
                                                                                    <fo:table-cell padding="2pt" display-align="before">
                                                                                        <fo:block>
                                                                                            <fo:inline>
                                                                                                <xsl:text>Carry forward from year to the current period is hereby authorized as follows:</xsl:text>
                                                                                            </fo:inline>
                                                                                        </fo:block>
                                                                                    </fo:table-cell>
                                                                                    <fo:table-cell padding="2pt" display-align="before">
                                                                ...
                                                                <xsl:if test="subcontract:SubContractData/subcontract:SubcontractDetail/subcontract:ModificationType = &quot;RESBOOT1002&quot;">
                                                                    <fo:block>
                                                                        <fo:inline>
                                                                            ...
                                                                            <xsl:text> is hereby added to the Subaward Period of Performance, which is revised to be consistent with the Subaward Period of Performance Start and End Date above. </xsl:text>
                                                                        </fo:inline>
                                                                        <fo:table padding="0" table-layout="fixed" width="100%">
                                                                            <fo:table-column column-width="60%"/>
                                                                            <fo:table-column column-width="20%"/>
                                                                            ...
                                                                            <fo:table-body>
                                                                                <fo:table-row>
                                                                                    <fo:table-cell padding="2pt" display-align="before">
                                                                                        <fo:block>
                                                                                            <fo:inline>
                                                                                                <xsl:text>The total amount authorized for year   to the current  period is hereby authorized as follows:</xsl:text>
                                                                                            </fo:inline>
                                                                                        </fo:block>
                                                                                    </fo:table-cell>
                                                                                    <fo:table-cell padding="2pt" display-align="before">
                                                                        ...
                                                                        <fo:inline>
                                                                            <xsl:text>
                                                                                The PTE hereby affirms the budget was not cut or was cut by less than 10% from the proposed budget for the current year.
                                                                            </xsl:text>
                                                                        </fo:inline>
                                                                    </fo:block>
                                                                </xsl:if>
                                                ...
                                                <fo:block linefeed-treatment="preserve" margin="2pt" text-align="left">
                                                    <fo:table padding="0" table-layout="fixed" width="100%">
                                                        ...
                                                        <fo:table-body>
                                                            <fo:table-row>
                                                                <fo:table-cell padding="2pt" height="70pt" display-align="before">
                                                                    <fo:block>
                                                                        <xsl:for-each select="subcontract:SubContractData">
                                                                            <xsl:for-each select="subcontract:SubcontractDetail">
