 ...
 * for that award.
 */
public class AdminModifyAwardAuthorizer extends AwardAuthorizer {
    ...
    protected boolean canUserModifyAward(String userId, Award award, AwardDocument doc){
        return !award.getAwardDocument().isViewOnly() &&
                   hasPermission(userId, award, AwardPermissionConstants.ADMIN_MODIFY_AWARD.getAwardPermission());
