...
public class IrbProtocolRulesEngineExecutorImpl  extends KcRulesEngineExecuter {
    ...
    public EngineResults performExecute(RouteContext routeContext, Engine engine) {
        ...
        contextQualifiers.put(KcKrmsConstants.NAMESPACE_CODE, Constants.MODULE_NAMESPACE_IRB);
        contextQualifiers.put(KcKrmsConstants.NAME, KcKrmsConstants.IrbProtocol.IRB_PROTOCOL_CONTEXT);
