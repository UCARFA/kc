...
public interface FrequencyWebService {
	...
	public FrequencyDto getFrequency(@WebParam(name = ReportTrackingConstants.FREQUENCY_CODE) String frequencyCode);
	
	public List<FrequencyDto> findMatching(@WebParam(name = ReportTrackingConstants.FREQUENCY_CODE) String frequencyCode, @WebParam(name = "description") String description);
