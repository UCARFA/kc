...
public interface Constants {
    ...
    String MM_DD_YY_DATE_FORMAT = "MM/dd/yy";
    ...
    String VERSION_LOCK = "VersionLock";
    String DOCUMENT_NUMBER_FIELD = "document.documentHeader.documentNumber";
    String AWARD = "Award";
    String INSTITUTIONAL_PROPOSAL = "Institutional Proposal";
