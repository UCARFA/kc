package edu.ucar.fanda.kuali.kra.award.service.impl;
...
@Transactional
public class UcarAwardScheduleGenerationServiceImpl extends AwardScheduleGenerationServiceImpl {
    ...
    public UcarAwardScheduleGenerationServiceImpl(){
    ...
    protected List<Date> getDatesWithForward(AwardReportTerm awardReportTerm, Map<String, java.util.Date> mapOfDates, int index) throws ParseException {
        ...
        if (startDate != null && endDate != null) {
            ...
            if (awardReportTerm.getFrequency().getRepeatFlag()
                ...
                // AS required dates
                if (awardReportTerm.getFrequencyBaseCode().equals("6")) {
