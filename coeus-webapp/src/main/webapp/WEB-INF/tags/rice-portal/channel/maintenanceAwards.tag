...
<div class="body">
  <ul class="chan">
    ...
    <li><portal:portalLink displayTitle="true" title="Report Status" url="${ConfigProperties.application.url}/kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.kra.award.paymentreports.ReportStatus&docFormKey=88888888&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true" /></li>
  	...
  	<li><portal:portalLink displayTitle="true" title="Award Report Tracking Notifications" url="${ConfigProperties.application.url}/kr-krad/lookup?methodToCall=start&viewId=SentReportNotification-LookupView&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true&docFormKey=88888888" /></li>
  </ul>
</div>
